...
exports.sendMail = async (userEmail, order, orderDetailSummary) => {
  try {
...
<![endif]-->
                                  ...
                                  >
                                    ...
                                    <h1
                                      ...
                                      "
                                    >
                                    Đơn hàng đấu giá yêu cầu hoàn trả
                                    </h1>
                                  </td>
                                </tr>
                              </table>
...
<![endif]-->
                                  ...
                                  >
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                        Yêu cầu hoàn trả đơn hàng đang được chúng tôi xử lý và
                                      chúng tôi cam kết hoàn thành xử lý trong 24h tới. Bạn sẽ
                                      nhận được thông tin cập nhật từ chúng tôi về
                                      tình trạng đơn đặt hàng của bạn và việc hoàn trả đơn hàng
                                    </p>
                                  </td>
                                </tr>
                              </table>

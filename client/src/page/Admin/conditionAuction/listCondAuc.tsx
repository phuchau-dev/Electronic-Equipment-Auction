          ...
          <main className="w-full flex-grow p-6">
                ...
                <div className="w-full mt-12">
                    <p className="text-xl pb-3 flex items-center">
                        <i className="fas fa-list mr-3"></i> DANH SÁCH ĐIỀU KIỆN ĐẤU GIÁ
                    </p>
                        ...
                        <table className="text-left w-full border-collapse"> 
                            ...
                            <tr className="hover:bg-grey-lighter">
                                        ...
                                        <td>
                                          ...
                                          >Xoá</a>
                                            <a  href="/admin/editCondition"className="delete-link p-4 cta-btn btn text-decoration:none;color:green;" >Sửa</a>
                                        </td>
                                    </tr>
                ...
                <div className="mt-6 flex gap-2">
                    <button className=" px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit"><a href="/admin/addConditon">Thêm mới</a></button>

...
const reciveCode: React.FC = () => {
    return (
        <>

            <div className="contain py-16">
                <div className="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
                    <h2 className="text-2xl uppercase font-medium mb-1">Nhập Mã Xác Thực</h2>
                    <p className="text-gray-600 mb-6 text-sm">Welcome back customer</p>
                    <form id="addLoginButton" action="" method="post" autoComplete="off">
                        <div className="space-y-2">
                            <div>
                                <label htmlFor="email" className="text-gray-600 mb-2 block">Mã xác thực</label>
